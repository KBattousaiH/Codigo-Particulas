...
#o.set_config('general:coastline_action', 'stranding')  # Se quiedan pegadas a la costa
...
#o.run(steps=51840,time_step=100,time_step_output=3600,outfile='OpenDrift_CV_h.nc')
o.run(steps=51840,time_step=100,time_step_output=21600,outfile='OpenDrift_CV_6h_landmask.nc')
#%%
# Print and plot results
# print(o)
o.plot(buffer=.2, fast=True, linecolor = 'z',filename='OpenDrift_CV6h_figlm.png')
#o.plot(filename='OD_cv.png')
